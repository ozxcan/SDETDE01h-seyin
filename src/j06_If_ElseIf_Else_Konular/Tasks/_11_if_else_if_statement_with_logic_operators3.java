...
public class _11_if_else_if_statement_with_logic_operators3 {
    ...
    /*  Eğer String null ("0") değilse ve String uzunluğu 14 ise ve String "i love java" yı kapsıyorsa
        ...
        //Stringlerde olumsuz ("!") ifadesi, stringin başına konur.
        // Matematiksel ifadelerde ise eşit değil, != şeklinde kullanılır.

        if (!str.equals("0") && str.length() == 14 && str.contains("i love java")) { // !str.equals(0) String sıfır değilse demek.
            System.out.println("String is i love java and 14 character.");

        } else {
            if (!str.equals("0") && str.equalsIgnoreCase(str)) {
