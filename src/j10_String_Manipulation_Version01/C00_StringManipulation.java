...
// codePointAt(): Belirtilen indisteki karakterin ASCII kodunu verir. int döndürür.
...
// concat(): Başka bir String'in sonuna bir string ekler. String döndürür.
...
// contentEquals(): Bir dizenin, belirtilen aynı karakter dizisini içerip içermediğini kontrol eder. boolean döndürür.
          // İki string birbirine eşit mi diye sorgular. Boolean olarak döndürür.
...
// ***** indexOf(): Bir dizede belirtilen karakterlerin bulunduğu yerdeğik index konumunu verir. int döndürür.
...
// *** lastIndexOf(): Bir dizede belirtilen karakterlerin bulunduğu son index konumunu verir. int döndürür.
        // Söylenen harfin ya da kelimenin sondan başlayarak string içinde bulduğu yerdeki indeksini verir.
...
// *****replace(): Belirli bir değer için bir dize arar ve belirtilen değerlerin değiştirildiği yeni bir dize döndürür. String döndürür.
        ...
        System.out.println(myStr18.replace('l', 'p')); // output - Heppo
...
// *****valueOf(): Bir String nesnesinin ilkel değerini verir. String döndürür.
        //String.valueOf() dönüştürme için kullanılır. Parantez içindeki değeri String yapar.
        String str22 = "22";
